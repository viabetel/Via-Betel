...
import { MessageCircle, ChevronDown, User, LogOut, ClipboardList } from "lucide-react"
            ...
            {!user ? (
              <>
                ...
                <Link href="/auth/login">
                  <Button
                    variant="ghost"
                    className="text-white hover:bg-white/10 text-xs sm:text-sm px-2 sm:px-3 py-1.5 sm:py-2"
                  >
                    Entrar
                  </Button>
                </Link>
              ...
              <>
                {/* Logado: Chat icon com badge + Avatar menu */}
                <Link href="/chat" className="relative">
                  <Button variant="ghost" size="sm" className="text-white hover:bg-white/10 p-2 rounded-full relative">
                    ...
                    {openDropdown === "user-menu" && (
                      ...
                      >
                        <div className="px-4 py-2 border-b border-emerald-200">
                          <p className="font-semibold text-emerald-900 text-sm">{profile?.full_name || "Usuário"}</p>
                          <p className="text-xs text-gray-600">{profile?.email}</p>
                        </div>
                        <Link
                          href="/chat"
                          onClick={() => setOpenDropdown(null)}
                          className="flex items-center gap-2 px-4 py-2.5 text-emerald-900 hover:bg-gradient-to-r hover:from-emerald-500 hover:to-teal-500 hover:text-white text-sm transition-all"
                        >
                        ...
                        <button
                          ...
                          className="w-full flex items-center gap-2 px-4 py-2.5 text-red-600 hover:bg-red-50 text-sm transition-all border-t border-emerald-200 mt-1"
                        >
