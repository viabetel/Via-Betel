...
import PlanModal from "@/components/PlanModal" // Import PlanModal component
  ...
  return (
    <>
      ...
      <PlanModal
        ...
        onClose={() => setPlanModalState({ ...planModalState, isOpen: false })}
        instructorSlug={planModalState.instructorSlug}
        instructorName={planModalState.instructorName}
      />
    </>
  )
}
